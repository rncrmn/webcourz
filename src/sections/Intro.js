...
const Intro = () => {
    return (
        <div className="relative min-h-screen bg-white dark:bg-black" id="home">
            <div className="absolute dark:hidden md:w-96 md:h-96 bg-blue-100 rounded-full z-[1] opacity-90 right-auto top-auto md:right-1/4 md:top-64" />
